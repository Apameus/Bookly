...
import gr.bookapp.common.BooklyConfig;
...
public final class AppServer {
    ...
    public static void main(String[] args) throws IOException {
        BooklyConfig booklyConfig; // TODO: Set booklyConfig from server side
        ...
        // --- User
        FileBasedNodeStorageTree<Long, User> userNodeStorage = new FileBasedNodeStorageTree<>(booklyConfig.userPath(), longCodec, userCodec);
        ...
        Logger.Factory logFactory = new CompositeLoggerFactory(new FileLogger(booklyConfig.logsPath()));
