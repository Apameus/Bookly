...
public final class BookRepository {
    ...
    private final Index<Book, List<String>> authorIndex = Book::author;
    ...
    public List<Book> findBooksWithTags(List<String> tag){
        return bookDatabase.findAllByIndex(tagIndex, tag);
    }
